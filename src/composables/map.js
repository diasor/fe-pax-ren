export function useMap() {
    function fullMap(franceCoordX, franceCoordY) {
        ...
        mapArea.push(area("france", "France", franceCoordX, franceCoordY, "kingdom"));
        mapArea.push(area("roman-empire", "Holy Roman Empire", 668, X_FIRST_LINE, "kingdom"));
        ...
        mapArea.push(area("papal-states", "Papal States", 668, X_SECOND_LINE, "kingdom"));
        mapArea.push(area("ottoman", "Ottoman", 834, X_SECOND_LINE, "kingdom"));
        mapArea.push(area("mamluk", "Mamluk", 1003, X_SECOND_LINE, "kingdom"));

        // victories
        mapArea.push(area("renaissance-victory", "RenaissanceVictory", 144, 124, "victory"));
