...
export const board = {
    ...
    getters: {
        ...
        getKingdomByName: (state) => (name) =>
            find(state.kingdoms, (kingdom) => kingdom.name === name),
    ...
    mutations: {
        SET_VICTORY_LIST(state, victories) {
            state.victories.isRenaissanceVictoryActive =
                victories.isRenaissanceVictoryActive;
            state.victories.isGlobalizationVictoryActive =
                victories.isGlobalizationVictoryActive;
            state.victories.isImperialVictoryActive =
                victories.isImperialVictoryActive;
    ...
    actions: {
        async newGameBoard({ commit, dispatch }) {
            ...
            await dispatch("kingdoms/setAllKingdoms", data.kingdoms, {
                root: true,
            });
            ...
            // bankers
            await dispatch("bankers/setAllBankers", data.bankers, {
                root: true,
            });
        },
