    ...
    actions: {
        setBorders( { commit }, borders ) {
            forEach(borders, (itemBorder) => {
                ...
                if (itemBorder.firstKingdom === KINGDOM_NAMES.ENGLAND && itemBorder.secondKingdom === KINGDOM_NAMES.FRANCE) {
                    border.borderName = `${KINGDOM_NAMES.ENGLAND}-${KINGDOM_NAMES.FRANCE}`;
                    commit("SET_BORDER", { border, borderNumber: "1"});
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.ENGLAND && itemBorder.secondKingdom === KINGDOM_NAMES.PORTUGAL) {
                    border.borderName = `${KINGDOM_NAMES.ENGLAND}-${KINGDOM_NAMES.PORTUGAL}`;
                    commit("SET_BORDER", { border, borderNumber: "2" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.FRANCE && itemBorder.secondKingdom === KINGDOM_NAMES.HRE) {
                    border.borderName = `${KINGDOM_NAMES.FRANCE}-${KINGDOM_NAMES.HRE}`;
                    commit("SET_BORDER", { border, borderNumber: "3" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.FRANCE && itemBorder.secondKingdom === KINGDOM_NAMES.ARAGON) {
                    border.borderName = `${KINGDOM_NAMES.FRANCE}-${KINGDOM_NAMES.ARAGON}`;
                    commit("SET_BORDER", { border, borderNumber: "4" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.HRE && itemBorder.secondKingdom === KINGDOM_NAMES.HUNGARY) {
                    border.borderName = `${KINGDOM_NAMES.HRE}-${KINGDOM_NAMES.HUNGARY}`;
                    commit("SET_BORDER", { border, borderNumber: "5" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.HRE && itemBorder.secondKingdom === KINGDOM_NAMES.PAPAL_STATES) {
                    border.borderName = `${KINGDOM_NAMES.HRE}-${KINGDOM_NAMES.PAPAL_STATES}`;
                    commit("SET_BORDER", { border, borderNumber: "6" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.HUNGARY && itemBorder.secondKingdom === KINGDOM_NAMES.BYZANTIUM) {
                    border.borderName = `${KINGDOM_NAMES.HUNGARY}-${KINGDOM_NAMES.BYZANTIUM}`;
                    commit("SET_BORDER", { border, borderNumber: "7" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.HUNGARY && itemBorder.secondKingdom === KINGDOM_NAMES.OTTOMAN) {
                    border.borderName = `${KINGDOM_NAMES.HUNGARY}-${KINGDOM_NAMES.OTTOMAN}`;
                    commit("SET_BORDER", { border, borderNumber: "8" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.BYZANTIUM && itemBorder.secondKingdom === KINGDOM_NAMES.MAMLUK) {
                    border.borderName = `${KINGDOM_NAMES.BYZANTIUM}-${KINGDOM_NAMES.MAMLUK}`;
                    commit("SET_BORDER", { border, borderNumber: "9" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.PORTUGAL && itemBorder.secondKingdom === KINGDOM_NAMES.ARAGON) {
                    border.borderName = `${KINGDOM_NAMES.PORTUGAL}-${KINGDOM_NAMES.ARAGON}`;
                    commit("SET_BORDER", { border, borderNumber: "10" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.ARAGON && itemBorder.secondKingdom === KINGDOM_NAMES.PAPAL_STATES ) {
                    border.borderName = `${KINGDOM_NAMES.ARAGON}-${KINGDOM_NAMES.PAPAL_STATES}`;
                    commit("SET_BORDER", { border, borderNumber: "11" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.PAPAL_STATES && itemBorder.secondKingdom === KINGDOM_NAMES.OTTOMAN) {
                    border.borderName = `${KINGDOM_NAMES.PAPAL_STATES}-${KINGDOM_NAMES.OTTOMAN}`;
                    commit("SET_BORDER", { border, borderNumber: "12" });
                } else if (itemBorder.firstKingdom === KINGDOM_NAMES.OTTOMAN && itemBorder.secondKingdom === KINGDOM_NAMES.MAMLUK) {
