...
export default ({
    ...
    setup() {
        ...
        const refreshBorders = computed(() => store.getters["borders/getRefreshBorders"]);
        
        let showBorder1 = ref(false);
        let border1Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder2 = ref(false);
        let border2Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder3 = ref(false);
        let border3Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder4 = ref(false);
        let border4Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder5 = ref(false);
        let border5Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder6 = ref(false);
        let border6Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder7 = ref(false);
        let border7Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder8 = ref(false);
        let border8Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder9 = ref(false);
        let border9Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder10 = ref(false);
        let border10Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder11 = ref(false);
        let border11Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder12 = ref(false);
        let border12Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
        let showBorder13 = ref(false);
        let border13Card = ref({ cardId: "", cardType: CARD_TYPE.BORDER, pieceId: "", cardPosition: CARD_POSITION.HORIZONTAL });
