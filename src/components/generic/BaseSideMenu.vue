...
export default defineComponent({
  ...
  setup(_, context) {
    ...
    const showFugger = computed(() => store.getters["bankers/isFuggerPlaying"]);
    const showMedici = computed(() => store.getters["bankers/isMediciPlaying"]);
    const showCoeur = computed(() => store.getters["bankers/isCoeurPlaying"]);
