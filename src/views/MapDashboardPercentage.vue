<template>
    <div>
        ...
        <div id="pr-map" class="map-container">
            ...
            <img v-if="showIslamico" :src="`/images/${KINGDOM_FILES[0].file}`" class="france" :style="franceDynamicClass" />
...
export default {
    ...
    setup(){
        ...
        */
        ...
        return { franceDynamicClass, KINGDOM_FILES, renderCard, showIslamico, showReformista, activateRenaissanceVictory, doSomething, imageClick, kingdomMap }
    },
